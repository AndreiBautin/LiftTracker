    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, true, 0, "Flat Bench Press" },
                    { 2, 1, true, 0, "Incline DB Bench Press" },
                    { 3, 1, true, 0, "Incline Bench Press" },
                    { 4, 2, false, 0, "Pec Deck" },
                    { 5, 2, false, 0, "Incline Fly" },
                    { 6, 2, false, 1, "Rope Pushdown" },
                    { 7, 2, false, 1, "Overhead Rope Extension" },
                    { 8, 0, true, 9, "Military Press" },
                    { 9, 1, true, 9, "Seated Military Press" },
                    { 10, 1, true, 9, "DB Shoulder Press" },
                    { 11, 2, false, 9, "DB Front Raise" },
                    { 12, 2, false, 2, "DB Lateral Raise" },
                    { 13, 2, false, 2, "Upright Row" },
                    { 14, 2, true, 3, "DB Row" },
                    { 15, 2, true, 3, "Chin-Ups" },
                    { 16, 2, false, 4, "Hammer Curl" },
                    { 17, 2, false, 4, "Preacher Curl" },
                    { 18, 2, false, 5, "Reverse Pec Deck" },
                    { 19, 2, false, 5, "Face Pull" },
                    { 20, 2, false, 10, "DB Shrugs" },
                    { 21, 2, false, 10, "Barbell Shrugs" },
                    { 22, 2, false, 11, "DB Wrist Curl" },
                    { 23, 2, false, 11, "Barbell Wrist Curl" },
                    { 24, 0, true, 6, "Low Bar Squat" },
                    { 25, 1, true, 6, "Hack Squat" },
                    { 26, 1, true, 6, "High Bar Squat" },
                    { 27, 2, false, 6, "Leg Extension" },
                    { 28, 0, true, 7, "Sumo Deadlift" },
                    { 29, 1, true, 7, "RDL" },
                    { 30, 1, true, 7, "Conventional Deadlift" },
                    { 31, 2, false, 7, "Leg Curl" },
                    { 32, 2, false, 12, "Standing Calf Raise" },
                    { 33, 2, false, 12, "Seated Calf Raise" },
                    { 34, 2, false, 8, "Hanging Leg Raise" },
                    { 35, 2, false, 8, "Weighted Decline Situp" }
                });
